...
(function() {
    ...
    // Initialize chat directly without registration
    async function initializeChat() {
        // Hide welcome screen, show chat interface directly
        chatWelcome.style.display = 'none';
        chatBody.classList.add('active');
        
        // Generate default values for identification
        ...
        try {
            ...
            // Send default user info to initialize session
            const userInfoData = {
                action: "sendMessage",
                sessionId: conversationId,
                route: settings.webhook.route,
                chatInput: "", // Empty initial message
                metadata: {
                    userId: defaultEmail,
                    userName: defaultName,
                    isUserInfo: true
    ...
    async function submitMessage(messageText) {
        ...
        // Use default values for guest user
    ...
    // Event listeners
    startChatButton.addEventListener('click', initializeChat); // Thay thế showRegistrationForm bằng initializeChat
